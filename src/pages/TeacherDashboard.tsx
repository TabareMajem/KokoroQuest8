...
import BullyingDetection from '../components/teacher/bullying/BullyingDetection';
...
type TabType = 'overview' | 'students' | 'parents' | 'activities' | 'analytics' | 'bullying' | 'settings';
...
export default function TeacherDashboard() {
  ...
  const tabs = [
    ...
    { id: 'bullying', label: 'Bullying', icon: AlertCircle },
